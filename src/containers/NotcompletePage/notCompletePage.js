  ...
  return (
    <div style={{ width: "100%" }}>
      ...
      >
        ...
        <div id="af-form-1946495044" className="af-form">
          {/* <div id="af-header-1946495044" className="af-header">
                <div className="bodyText">
                    <p>&nbsp;</p>
                </div>
            </div> */}
          <div id="af-body-1946495044" className="af-body af-standards">
            <div className="af-element">
              {/* <label className="previewLabel" for="awf_field-113242042">Email: </label> */}

              <div className="af-textWrap inputDiv filter">
                <input
                  placeholder="Entrez votre e-mail"
                  className="text"
                  id="awf_field-113242042"
                  type="text"
                  name="email"
                  tabIndex={500}
                />
              ...
              {/* <div className="af-textWrap inputDiv filter"><input className="text" id="awf_field-113242042" type="text" name="email"
            ...
            {/* <div className="af-element buttonContainer">
                    <input name="submit" className="submit" type="submit" value="Envoyer" tabindex="501" />
                    <div className="af-clear"></div>
                </div> */}
          </div>
          <div id="af-footer-1946495044" className="af-footer">
            <div className="bodyText">
              <p>&nbsp;</p>
            </div>
          </div>
        ...
        <div style={{ display: "none" }}>
          <img
            src="https://forms.aweber.com/form/displays.htm?id=jJwsbCycrAwsLA=="
            alt=""
          />
        </div>
        <div className="AW-Form-1946495044"></div>
      </form>
...
function NotCompletePage(props) {
  return (
    <div className="container errorPageMain">
      ...
      <h2>
        Bientôt, Planipets sera avec vous et pour vos animaux de compagnie
      </h2>
      <h3>
        Entrez ci-dessous votre adresse mail pour vous tenir au courant de la
        révolution Planipets.{" "}
      </h3>
...
export default connect(mapStateToProps, mapDispatchToProps)(NotCompletePage);
