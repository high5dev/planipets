      ...
      <div>
        <Layout>
          <Switch>
            ...
            <Route exact path="/test" component={Home} loading={true} /> {/*//correct*/}
            ...
            <Route exact path="/vet-listings" component={Listing} /> {/*//correct*/}
            <Route exact path="/vet/:id/:name" component={Vet} /> {/*//correct*/}
            <Route exact path="/profile" component={Profile} /> {/*//correct*/}
            <Route exact path="/vet/:id/:name/profile" component={Profile} /> {/*//correct*/}
...
(
  {
  auth,bookingData:bookAppointment
})

const mapDispatchToProps = dispatch =>
  bindActionCreators(
    {
      getUserCredentials, bookAppointment
